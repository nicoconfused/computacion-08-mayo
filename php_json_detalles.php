...
<p>La húmedad ambiental es: <strong><?php echo round ($datos["data"]["sensors"][2]["value"]);?></strong></p>
<p>La iluminación es: <strong><?php echo round ($datos["data"]["sensors"][0]["value"]);?></strong></p>
<p>El ruido es: <strong><?php echo round ($datos["data"]["sensors"][4]["value"]);?></strong></p>
